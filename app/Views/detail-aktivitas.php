...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="color: #009EF2;" href="aktivitas">Aktivitas</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <!-- Judul Aktivitas -->
        <div class="activity-title">SonicPulse Meluncurkan Produk Baru Bernama "SonicPulse Pro" dsdsdddddddddddddd
            ddddddddddddddd ddddddddddd</div>

        <!-- Gambar Utama -->
        <img src="IMG/S1.jpg" class="main-image" alt="Main Activity Image" loading="lazy">

        <!-- Thumbnail Gambar -->
        <div class="thumbnail-images">
            <img src="IMG/S1.jpg" alt="Thumbnail 1" loading="lazy">
            <img src="IMG/S3.jpg" alt="Thumbnail 2" loading="lazy">
            <img src="IMG/S2.jpg" alt="Thumbnail 3" loading="lazy">
        </div>

        <!-- Isi Aktivitas -->
        <div class="activity-content">
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce euismod, lorem vel commodo finibus, ex
                augue
                ultrices nisi, at auctor magna purus non mauris. Quisque mollis lacus sed justo placerat, id volutpat
                magna
                dapibus. Sed nec arcu et nisi scelerisque ullamcorper. Mauris sit amet dignissim orci.
            </p>
            <p>
                Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Integer ut
                vestibulum
                erat. Cras bibendum elit ut ante scelerisque, et varius purus malesuada. Proin non lorem eu nulla
                tincidunt
                bibendum ut ac odio.
                Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Integer ut
                vestibulum
    ...
    <div class="related-products text-center">
        <h3 style="color: #009EF2;">Aktivitas Terkait</h3>
    </div>
    ...
    <div class="container mt-2 mb-2">
        <div class="row">
            <div class="col-md-4">
                <a href="detail-aktivitas" style="text-decoration: none; color: inherit;">
                    <div class="card">
                        <img src="IMG/S3.jpg" class="card-img-top" alt="..." loading="lazy">
                        <div class="card-body">
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                ...
                                the
                                card's
                                contentsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss.
                            </p>
                        </div>
                    </div>
                </a>
